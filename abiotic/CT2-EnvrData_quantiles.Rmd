...
temp_quantile_10 <- quantile(CT2_temp$temp, 0.1)
temp_quantile_90 <- quantile(CT2_temp$temp, 0.9)
...
CT2_temp <- cbind(site_name, download_date, source_description, lat, lon, firstyear, finalyear, Mean_Annual_Temperature_C, Mean_max_temperature_C, Mean_min_temperature_C, Temperature_st_dev, Temperature_n, Temperature_years, temp_quantile_10, temp_quantile_90, collection_type)
print(CT2_temp)
...
salinity_quantile_10 <- quantile(CT2_sal$salinity, 0.1)
salinity_quantile_90 <- quantile(CT2_sal$salinity, 0.9)
...
#Create a data frame to store the temperature results
CT2_salinity <- cbind(site_name, download_date, source_description, lat, lon, firstyear, finalyear, Mean_Annual_Salinity_ppt, Mean_max_Salinity_ppt, Mean_min_Salinity_ppt, Salinity_st_dev, Salinity_n, Salinity_years, salinity_quantile_10, salinity_quantile_90, collection_type)
print(CT2_salinity)
